        ...
        {status === "success" ? (
          <div className="card p-10 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-text-secondary leading-relaxed">
              Your request has been received. Our team will be in touch within 24 hours.
            </p>
            <button
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  id="email" type="email" placeholder="you@company.com" required
                  className="w-full rounded-lg border border-border bg-bg-card px-4 py-2.5 text-text placeholder:text-text-muted/50 focus:outline-none focus:border-brand/40 focus:ring-1 focus:ring-brand/20 transition-colors"
                />
              </div>
            </div>
            <div>
              ...
              <input
                id="company" type="text" placeholder="Company name" required
                className="w-full rounded-lg border border-border bg-bg-card px-4 py-2.5 text-text placeholder:text-text-muted/50 focus:outline-none focus:border-brand/40 focus:ring-1 focus:ring-brand/20 transition-colors"
              />
            </div>
            <div>
