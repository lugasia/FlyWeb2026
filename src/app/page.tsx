    ...
    <>
      ...
      <Section id="about">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <h2 className="text-3xl md:text-4xl font-bold font-[family-name:var(--font-space-grotesk)] mt-4 mb-6">
            Welcome to Flycomm
          </h2>
          <p className="text-xl text-brand font-semibold font-[family-name:var(--font-space-grotesk)] mb-4">
            The world suffers from BLINDNESS regarding wireless communication.<br />
          ...
          <p className="text-lg text-text-secondary leading-relaxed max-w-3xl mx-auto">
            Flycomm is your one-stop solution for analyzing and planning mobile connectivity. We make managing and analyzing cellular connectivity easy for sectors like municipalities, transportation, security, and IoT. Our AI-driven technology offers clear insights into network performance, helping decision-makers optimize wireless communication.
          </p>
        </div>
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-text-muted">The team behind Flycomm</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            ...
            },
            {
              name: "Arie Lugasi",
              role: "Co-Founder & CTO",
              desc: "Telecommunications engineer with 35+ years of expertise at Motorola and Israel Aerospace Industries (IAI). International expert in wireless technologies and RF systems architecture. The technical visionary behind Flycomm's AI-powered platform.",
            },
            {
              name: "Yehuda Kohn",
              role: "Chief Revenue Officer",
              desc: "Seasoned executive with 20+ years driving global sales, business development, and strategic partnerships. Proven track record of expanding market share and increasing profits across multiple industries.",
            },
          ].map((member) => (
            <div
              key={member.name}
              className="card p-8 text-center"
            >
              <div className="w-20 h-20 rounded-full bg-brand/20 border-2 border-brand/40 flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-brand font-[family-name:var(--font-space-grotesk)]">
              ...
              <p className="text-sm text-brand font-medium mb-3">{member.role}</p>
              <p className="text-sm text-text-secondary leading-relaxed">
                {member.desc}
              </p>
            </div>
