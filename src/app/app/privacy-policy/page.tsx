...
export const metadata: Metadata = {
  title: "Flycomm Networks App – Privacy Policy",
  description:
    "Privacy policy for the Flycomm Networks mobile App. Learn how we collect, use, and protect your data when you use the App.",
  alternates: { canonical: "/app/privacy-policy" },
  openGraph: {
    title: "Flycomm Networks App – Privacy Policy",
    description:
      "Privacy policy for the Flycomm Networks mobile App. Learn how we collect, use, and protect your data when you use the App.",
    ...
    <article className="min-h-screen">
      <div className="max-w-4xl mx-auto px-6 md:px-12 pt-32 pb-20">
        ...
        <h1 className="text-3xl md:text-4xl font-bold font-[family-name:var(--font-space-grotesk)] mb-3">
          Flycomm Networks App &ndash; Privacy Policy
        </h1>
        <p className="text-text-muted text-sm mb-6">Flycomm Networks App</p>

        <a
          href="https://play.google.com/store/search?q=flycomm&c=apps"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 rounded-md bg-brand px-4 py-2 text-sm font-medium text-white hover:bg-brand-light transition-colors mb-10"
        >
        ...
        <div className="legal-content space-y-6">
          ...
          <p>
            ...
            <a
              href="https://mobile.flycomm.co/files/privacy-policy.pdf"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <p>
            Download the Flycomm Networks App on{" "}
            <a
              href="https://play.google.com/store/search?q=flycomm&c=apps"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <p>
            Personal Information - Personal Information in this Privacy Policy refers to any information that may be used to identify an individual.
          </p>
          <p>The Personal Information which is collected by the App may include:</p>
          <ul>
            <li>Mobile device ID - (Apple\Android ID) as well as other identifiers such as SIM card information.</li>
            <li>Location data - while the App is in use (&quot;location when in use&quot;) and/or when the App is running in the background (&quot;location always&quot;) (in accordance with the permissions and preferences granted by the user on their device).</li>
            <li>Contact Information (if applicable) - Full name, e-mail and/or physical addresses, phone number, date of birth etc.</li>
          </ul>
          <p>
          ...
          <ul>
            <li>Our need to carry out the above collection and processing of information is for the purpose of providing Our Services in accordance with Our Terms and Conditions and/or for the purpose of customer support and inquiries. To the extent that We use the Personal Information to for the purpose of providing Our Services in accordance with Our Terms and Conditions, the basis is your freely given informed consent, as well as Our legitimate business interest.</li>
          ...
          <ul>
            <li>To evaluate and measure the performance of communication networks, including their quality of service, reception level and other traffic characteristics, and to offer Flycomm&apos;s clients information and analysis regarding the performance of communication networks, including in respect of the performance of different apps;</li>
            ...
            <li>To administrate and improve Our App and Services, or any other product under development, for Our internal records and/or for statistical analysis;</li>
          ...
          <ul>
            <li>
              You may at any time request the rectification or erasure of your Personal Information. Please note however that deletion could mean that Flycomm cannot process your requests and/or provide you any Services and/or you may not be able to make any use of the App. You have the right to request a copy of your Personal Information from Our records. You have the right to request a limitation of the use of your Personal Information or the termination of use of your Personal Information. If you wish to delete or modify your Personal Information you can do so within the settings of your account, when possible, or you can send Us an e-mail with your request to:{" "}
              <a href="mailto:office@flycomm.co" className="text-brand hover:text-brand-light underline underline-offset-2">
                office@flycomm.co
              </a>
              {" "}and We will make reasonable efforts to modify or delete any such Personal Information within a reasonable period of time, and pursuant to any applicable privacy laws. This actions also apply if you wish to modify, cancel or opt-out of your account
            </li>
          ...
          <p>
            If you have any questions or queries about this Privacy Policy or regarding the way We collect or processPersonal Information, you may contact Us via e-mail at:{" "}
            <a href="mailto:office@flycomm.co" className="text-brand hover:text-brand-light underline underline-offset-2">
              office@flycomm.co
            </a>
            .
