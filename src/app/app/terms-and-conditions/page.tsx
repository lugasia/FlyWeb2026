...
export const metadata: Metadata = {
  title: "Flycomm Networks App – Terms and Conditions",
  description:
    "Terms and conditions for the Flycomm Networks mobile App. Read the legally binding agreement that governs your use of the App and Services.",
  alternates: { canonical: "/app/terms-and-conditions" },
  openGraph: {
    title: "Flycomm Networks App – Terms and Conditions",
    description:
      "Terms and conditions for the Flycomm Networks mobile App. Read the legally binding agreement that governs your use of the App and Services.",
    url: "/app/terms-and-conditions",
  },
};

export default function AppTermsAndConditionsPage() {
  return (
    <article className="min-h-screen">
      <div className="max-w-4xl mx-auto px-6 md:px-12 pt-32 pb-20">
        ...
        <h1 className="text-3xl md:text-4xl font-bold font-[family-name:var(--font-space-grotesk)] mb-3">
          Flycomm Networks App &ndash; Terms and conditions
        </h1>
        <p className="text-text-muted text-sm mb-6">Flycomm Networks App &middot; Last Updated &mdash; March 2025</p>
        ...
        <div className="legal-content space-y-6">
          ...
          <p>
            Company&apos;s Platform is designed to present connectivity data of various communication networks, based on various parameters of communication networks detected through our technology, including their quality of service, reception level, and other traffic characteristics (the &quot;Technology&quot;). Based on sample measurements (the &quot;Sample Data&quot;), the Technology enables the Company to generate predictions for specific area defined by the Customer and evaluate the predicted performance of certain cellular communication networks in this area (the &quot;Polygon Data&quot;). The Company offers the Customerinformation and analysis based on the Polygon Data generated by the Technology (the &quot;Services&quot;).
          </p>
          ...
          <p>
            17. If You have any questions or queries about these Terms and Conditions or the Services in general, please do not hesitate to contact us via e-mail at: [
            <a href="mailto:support@flycomm.co" className="text-brand hover:text-brand-light underline underline-offset-2">
              support@flycomm.co
            </a>
            ]. Last Updated &ndash; March 2025
          </p>
        </div>
      </div>
    </article>
